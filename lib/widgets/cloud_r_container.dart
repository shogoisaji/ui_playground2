...
class CloudRContainer extends StatefulWidget {
  /// [waveCount] - 波の数,
  /// [color] - コンテナの色,
  /// [width] - コンテナの幅,
  /// [height] - コンテナの高さ,
  ...
  @override
  State<CloudRContainer> createState() => _CloudRContainerState();
}

class _CloudRContainerState extends State<CloudRContainer>
  ...
  @override
  void didUpdateWidget(CloudRContainer oldWidget) {
